...
@mlflow.trace(name="project14_dev_rag_clean", span_type="CHAIN")
def rag(question: str) -> dict:
    mlflow.update_current_trace(tags={
        "project": "project14",
        "phase": "dev_rag_e2e_clean",
...
if __name__ == "__main__":
    ...
    out_file = out_dir / "rag_dev_e2e_clean_result.json"
